...
export default function CreateProjectPage() {
  ...
  const handleGenerate = async () => {
    if (!topic.trim()) {
      setError("Please enter a topic for the project");
      return;
    }

    if (!moduleId) {
      setError("Please select a module for this project");
      return;
    }
    ...
    const prompt = `Create a capstone project about: ${topic}
...
- A project brief explaining the goal (HTML format)
- ${numTasks} tasks that build on each other
- Each task with step-by-step instructions
- Starter code and correct code answers
- A cohesive final result that applies learned concepts`;
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Generate a capstone project with multiple tasks using AI
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Provide information about the project you want to create
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="additional"
              placeholder="Specific features to build, design requirements, or learning objectives..."
        ...
        <Card className="border-green-200 dark:border-green-800">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Your new project has been saved to the database
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {(result.content?.tasks || result.raw?.tasks)?.map(
                (task: any, index: number) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                      {task.instructions?.length || 0} instructions
                    </p>
                  </div>
                )
              )}
